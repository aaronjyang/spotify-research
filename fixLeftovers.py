...
valences2018 = db.load("2018valences")
valences2019 = db.load("2019valences")
valences2020 = db.load("2020valences")
valences2021 = db.load("2021valences")
valences2022 = db.load("2022valences")
valences2023 = db.load("2023valences")
...
newLeftovers2023 = []
print(valences2023[0])
for i in range(len(leftovers2023)):
    weekLeftovers = []
    for x in leftovers2023[i][1]:
        if (leftoverCodes.get(x) != None):
            valences2023[i] = (valences2023[i][0], valences2023[i][1] + (db.getFeature(leftoverCodes.get(x), "valence"))/100)
        else:
            weekLeftovers.append(x)
    newLeftovers2023.append((valences2023[i][0], weekLeftovers))
db.save(valences2023, "2023ValencesFixed")
db.save(newLeftovers2023, "2023LeftoversFixed")